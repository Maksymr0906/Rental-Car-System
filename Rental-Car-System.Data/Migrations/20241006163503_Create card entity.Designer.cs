...
namespace Rental_Car_System.Data.Migrations
{
    ...
    [Migration("20241006163503_Create card entity")]
    partial class Createcardentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rental_Car_System.Data.Models.BankCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Rental_Car_System.Data.Models.RentalApplication", b =>
                {
                    b.HasOne("Rental_Car_System.Data.Models.Order", "Order")
                        .WithOne("RentalApplication")
                        .HasForeignKey("Rental_Car_System.Data.Models.RentalApplication", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
